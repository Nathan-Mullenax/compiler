...
TOKEN(CHAR_CONST),TOKEN(INT_CONST),TOKEN(FLOAT_CONST),TOKEN(STRING),

TOKEN(CHAR),TOKEN(INT),TOKEN(FLOAT),TOKEN(IDENTIFIER),TOKEN(EOF_TYPE),
...
TOKEN(STAR),TOKEN(DIV),TOKEN(MOD),TOKEN(NEGATION),TOKEN(ASSIGN),TOKEN(XOR_TOK),TOKEN(BIT_OR),TOKEN(BIT_AND),
TOKEN(ADD_TOK),TOKEN(SUB_TOK),TOKEN(GREATER),TOKEN(LESS),TOKEN(SHIFT_L),TOKEN(SHIFT_R),TOKEN(ADD_ASSIGN),
...
TOKEN(XOR_ASSIGN),TOKEN(OR_ASSIGN),TOKEN(AND_ASSIGN),TOKEN(AND_TOK),TOKEN(OR_TOK),TOKEN(INC),TOKEN(DEC),
